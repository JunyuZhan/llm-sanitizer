...
> **v0.1 已发布 · v0.2 开发中**:本地网关、15 类中文规则、实时看板/控制台、CLI、开机自启、CI 全部就绪;`pip install llm-sanitizer-gateway` 即可使用。v0.2 已落地 **WebSocket 透明代理**与**自定义敏感词表**,其余(格式脱敏、一键接入等)推进中。欢迎参与贡献。
