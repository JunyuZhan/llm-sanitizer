...
HIT_CASES = [
    ...
    ("案号半角(2026)京01民初123号", "案号"),   # 复核修复:半角括号
    ("车牌前缀 车牌粤B12345", "车牌号"),        # 复核修复:汉字前邻"车牌"
    ("新能源车牌 京AD12345", "车牌号"),
    ("户名王五", "姓名"),                       # 复核修复:户名角色词
    ("护照 E12345678", "证件号"),
    ...
    # v0.5 英文规则:SSN(严格校验)
    ("SSN 123-45-6789", "SSN"),
    ("Social Security 856-45-6787", "SSN"),
    ("001-01-0001", "SSN"),             # 边界:area 001
    ("SSN 899-99-9999", "SSN"),         # 边界:area 899
    # v0.5 英文规则:国际护照(强上下文 + 号码格式)
    ("Passport: AB1234567", "证件号"),
    ("passport number NB12345678", "证件号"),
    ("passport no. X1234567", "证件号"),
    ("travel document AB123456", "证件号"),
    ("美国护照 NB12345678", "证件号"),
]
...
FP_CASES = [
    ...
    # v0.5 英文误报样例:SSN 保留区号/超范围/零组/零序;日期/订单号等不误伤
    "666-45-6789",
    "900-45-6789",
    "123-00-6789",
    "123-45-0000",
    "日期 2026-08-27 是提交日",
    "订单号 AB1234567 无护照上下文",
    "参考编号 CD123456 与案件无关",
]
